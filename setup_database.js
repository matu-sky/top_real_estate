...
async function setupDatabase() {
    ...
    try {
        ...
        const pages = [
            ...
            { slug: 'reject-email-collection', title: '이메일무단수집거부', content: '<h1>이메일무단수집거부</h1><p>본 웹사이트에 게시된 이메일 주소가 전자우편 수집 프로그램이나<br>그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며,<br>이를 위반 시 <strong>정보통신망 이용촉진 및 정보보호 등에 관한 법률</strong>에 의해<br>형사 처벌됨을 유념하시기 바랍니다.</p>' },
